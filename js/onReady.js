...
// Animation        
        ...
        $('.num1').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num1').animateNumber({ number: 537 },2500);
            }
        });
        ...
        $('.num2').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num2').animateNumber({ number: 498 },2500);
            }
        });
        ...
        $('.num3').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num3').animateNumber({ number: 2.5 },2500);
            }
        });  
        ...
        $('.num4').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num4').animateNumber({ number: 236 },2500);
            }
        });        
...
// countdown (счетчик для акций)
    ...
    */
    ...
    if((new Date()) > ts){
    	...
    	ts = (new Date()).getTime() + 16*38*43*1000;
    	newYear = false;
    }
